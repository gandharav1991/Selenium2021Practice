...
public class TestSuiteBase extends TestBase implements ITest {
	...
	public void checkSuiteSkip() throws Exception{
		initialize();
		Log.info("Checking Runmode of Suite JoinUs");
		if(!TestUtil.isSuiteRunnable(suiteXls, "JoinUs suite")){
			Log.info("Skipped Suite SearchAdd as the runmode was set to NO");
			throw new SkipException("Runmode of Suite JoinUs suite set to no. So Skipping all tests in Suite JoinUs");
		}
